...
class Eksconfig(aws_madzumo.AWSbase):
    ...
    def create_node_group (self):
        ...
        ec2.create_nodegroup(
            ...
            nodegroupName = f"{self.eks_cluster_name}-nodegroup",
            scalingConfig = {
                'minSize': 2,
                'maxSize': 4,
                'desiredSize': 3
            ...
            tags = {
                self.tag_key_identity : self.tag_value_identity
            },
            capacityType = 'SPOT'
        )
